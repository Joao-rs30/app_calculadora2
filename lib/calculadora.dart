...
class _CalculadoraState extends State<Calculadora> {
  ...
  double _avaliarExpressao(String expressao) {
    ...
    ExpressionEvaluator evaliador = const ExpressionEvaluator();
    double resultado = evaliador.eval(Expression.parse(expressao), {});
    return resultado;
  }
